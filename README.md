...
- [05 MedicalGPT SFT 训练操作](./docs/05_medicalgpt_sft_training.md)
- [06 lm-evaluation-harness C-Eval 评估与 SwanLab](./docs/06_lm_eval_ceval_swanlab.md)
...
- [x] 准备 MedicalGPT 子项目 SFT 训练说明
- [x] 准备 lm-evaluation-harness C-Eval 评估流程
- [x] 准备 SwanLab 训练日志启动脚本
